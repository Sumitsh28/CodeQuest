  ...
  return (
    <div className="w-full flex flex-col gap-10 max-w-6xl mx-auto mt-3 mb-10 px-2">
      <div className="flex items-start gap-5 max-md:flex-col max-md:items-center">
        <div className="">
          <h1 className="font-semibold text-2xl py-2 text-[#3F74E6]">
            {problem?.order}. {problem?.title}
          </h1>

          <div className="py-2 text-light-4">
            <div
          ...
          <div className="mt-4">
            ...
            <div className="bg-[#9AA3AF] font-mono mt-1 py-2 px-3 rounded-lg">
              <div
                dangerouslySetInnerHTML={{ __html: problem?.sampleInput || "" }}
              />
            </div>
          </div>
        ...
        <div className="w-[350px] rounded-lg shadow-lg">
          <div className="bg-[#9AA3AF] rounded-t-lg py-2 px-4">
            <h2 className="font-medium">Submission Info</h2>
          </div>
          <div className="flex justify-between bg-light-4 items-center border-t border-light-3 py-2 px-4">
            <p className="font-medium">User Accepted</p>
            <div>19509</div>
          </div>
          <div className="bg-light-4 flex justify-between items-center border-t border-light-3 py-2 px-4">
            <p className="font-medium">User Tried</p>
            <div>19509</div>
          </div>
          <div className="flex justify-between items-center bg-light-4 border-t border-light-3 py-2 px-4">
            <p className="font-medium">Total Accepted</p>
            <div>19509</div>
          </div>
          <div className="bg-light-4 flex justify-between items-center border-t border-light-3 py-2.5 px-4">
            <p className="font-medium">Total Submissions</p>
            <div>19509</div>
          </div>
          <div className="flex justify-between items-center bg-light-4 border-t border-light-3 py-2 px-4 rounded-b-lg">
