export const mockProblemsData = [
  {
    ...
    title: "Two Sum",
    problemStatement:
      "Given an array of integers <code>nums</code> and an integer <code>target</code>, return <em>indices of the two numbers such that they add up to</em> <code>target</code>.</p><p class='mt-3'>You may assume that each input would have <strong>exactly one solution</strong>, and you may not use thesame element twice.<p class='mt-3'>You can return the answer in any order.</p>",
    inputFormat:
  ...
  },
  {
    ...
    problemStatement:
      "<p class='mt-3'>Given the <code>head</code> of a singly linked list, reverse the list, and return <em>the reversed list</em>.</p>",
    inputFormat:
      "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains an array of integers <code>nums</code> seperated by space</li>",
    outputFormat:
      "<li>One line with array of integers representing the reversed linked list</li>",
    sampleOutput: "5 4 3 2 1<br/>3 2 1<br/>1",
    sampleInput: "3<br/>1 2 3 4 5<br/>1 2 3<br/>1",
    constraints:
      "<li class='mt-2'>The number of nodes in the list is the range <code>[0, 5000]</code>.</li><li class='mt-2'><code>-5000 <= Node.val <= 5000</code></li>",
    difficulty: "Hard",
  ...
  },
  {
    ...
    problemStatement:
      "<p class='mt-3'>Given a string <code>s</code> containing just the characters <code>'('</code>, <code>')'</code>, <code>'{'</code>, <code>'}'</code>, <code>'['</code> and <code>']'</code>, determine if the input string is valid.</p> <p class='mt-3'>An input string is valid if:</p> <ul> <li class='mt-2'>Open brackets must be closed by the same type of brackets.</li> <li class='mt-3'>Open brackets must be closed in the correct order.</li><li class='mt-3'>Every close bracket has a corresponding open bracket of the same type. </li></ul>",
    inputFormat:
      "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains a series of paranthesis</li>",
    outputFormat:
      "<li>Print true if given string contains valid paranthesis, otherwise false</li>",
    sampleInput: "4<br/>()<br/>(){}[]<br/>(]<br/>([)]",
    sampleOutput: "true<br/>true<br/>false<br/>false",
    constraints:
      "<li class='mt-2'><code>1 <= s.length <= 10<sup>4</sup></code></li><li><class='mt-2 '><code>s</code> consists of parentheses only <code class='text-md'>'()[]{}'</code>.</li>",
    difficulty: "Easy",
    category: "Stack",
    order: 4,
    videoId: "wkDfsKijrZ8",
  ...
  },
  {
    ...
    problemStatement:
      "<p class='mt-3'>You are given an integer array <code>height</code> of length <code>n</code>. There are n vertical lines drawn such that the two endpoints of the <code>ith</code> line are <code>(i, 0)</code> and <code>(i, height[i])</code>.<br>Find two lines that together with the x-axis form a container, such that the container contains the most water.<br>Return the maximum amount of water a container can store.<br><b>Notice</b> that you may not slant the container.</p>",
    inputFormat:
      "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains an array of integers <code>height</code> seperated by space</li>",
    ...
    constraints:
      "<li class='mt-2'><code>n == height.length</code></li><li class='mt-2'><code>2 <= n <=10^5</code></li><li class='mt-2'><code>0 <= height[i] <= 10<sup>4</sup></code></li>",
    difficulty: "Medium",
  ...
  },
  {
    ...
    inputFormat:
      "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains an array of pair of integers representing <code>intervals</code> seperated by space</li>",
    outputFormat:
      "<li>One line with array of pair of integers representing merged intervals</li>",
  ...
  },
  {
    ...
    problemStatement:
      "<p class='mt-3'>Given the <code>root</code> of a binary tree, return <i>its maximum depth.</i><br> A binary tree's <b>maximum</b> depth is the number of nodes along the longest path from the root node down to the farthest leaf node.</p>",
    inputFormat:
      "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains an array of integers <code>root</code> seperated by space where -1 represents the <code>null</code> node</li>",
    outputFormat:
      "<li>One line with array of integers representing thr reversed linked list</li>",
    sampleOutput: "3<br/>2",
    sampleInput: "2<br/>3 9 20 -1 -1 15 7<br/>1 -1 2",
    constraints:
      "<li class='mt-2'>The number of nodes in the tree is in the range<code>[0, 10<sup>4</sup>]</code></li><li class='mt-2'><code>-100 <= Node.val <= 100</code></li>",
    difficulty: "Easy",
    category: "Tree",
    order: 8,
    videoId: "4qYTqOiRMoM",
  ...
  },
  {
    ...
    inputFormat:
      "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains an array of integers <code>prices</code> seperated by space</li>",
  ...
  },
  {
    ...
    title: "Subsets",
    problemStatement:
      "<p class='mt-3'>Given an integer array nums of unique elements, return <i>all possible <span class='text-sky-400'>subsets</span>(the power set).</i> The solution set <b>must not</b> contain duplicate subsets. Return the solution in <b>any order.</b></p>",
    inputFormat:
      "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains an array of integers <code>nums</code> seperated by space</li>",
    outputFormat:
      "<li>All the possible subsets excluding the empty set in different lines in any order</li>",
    sampleOutput: "1<br/>2<br/>1 2<br/>3<br/>1 3<br/>2 3<br/>1 2 3<br/>0",
    sampleInput: "2<br/>1 2 3<br/>0",
    constraints:
      "<li class='mt-2'><code>1 <= nums.length <= 10</code></li><li class='mt-2'><code>-10 <= num[i] <= 10</code></li><li class='mt-2'>All the numbers of <code>nums</code> are <b>unique</b>.</li>",
    difficulty: "Medium",
  ...
  },
  {
    ...
    title: "Rotate Image",
    problemStatement:
      "<p class='mt-3'>You are given an <code>n x n</code> 2D matrix representing an image, rotate the image by 90 degrees (clockwise).<br>You have to rotate the image <b>in-place</b>, which means you have to modify the input 2D matrix directly. <b>DO NOT</b> allocate another 2D matrix and do the rotation.</p>",
    inputFormat:
      "<li>First line will contain T, number of testcases. Then the testcases follow</li><li>The first line in each testcase contains an array of integers <code>matrix</code> seperated by space</li>",
    outputFormat: "<li>Print the rotated matrix</li>",
    sampleOutput: "7 4 1<br/>8 5 2<br/>9 6 3",
    sampleInput: "1<br/>1 2 3<br/>4 5 6<br/>7 8 9",
    constraints:
      "<li class='mt-2'><code>matrix.length == n</code></li><li class='mt-2'><code>matrix[i].length == n</code></li><li class='mt-2'><code>1 <= n <= 20</code></li><li class='mt-2'><code>-1000 <= matrix[i][j] <= 1000</code></li>",
    difficulty: "Medium",
    category: "Array",
    order: 11,
    videoId: "",
