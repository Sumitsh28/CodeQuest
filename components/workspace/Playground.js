    ...
    <div className="w-full flex flex-col">
      <div className="flex px-4 gap-2 justify-between max-md:mt-12 flex-wrap">
        ...
        <div className="flex gap-2 items-center">
          ...
          >
            <div className="h-6 w-6 font-bold text-2xl text-[#4BD4A3]">
              {!isFullScreen ? (
                <AiOutlineFullscreen />
              ) : (
      ...
      >
        ...
        <div className="!w-full min-h-[30%] flex flex-col">
          ...
          <div className="flex gap-5 flex-grow">
            <div className="!w-full flex flex-col">
              <h1 className="font-bold text-lg text-[#3F74E6]">Custom Input</h1>
              <CustomInput
        ...
        <div className="!w-full min-h-[30%] flex flex-col">
          ...
          <div className="flex gap-5 flex-grow max-xs:flex-col">
            ...
            <OutputWindow
              ...
              additionalStyles={"max-md:h-[250px]"}
            />
          </div>
        </div>
      </div>
